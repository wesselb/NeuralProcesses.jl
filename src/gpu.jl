...
function cudnnGetConvolutionForwardWorkspaceSize(y::CuArray{T,N}, x::CuArray{T,N}, w::CuArray{T,N},
                                                 cdims::DepthwiseConvDims; algo=0) where {T,N}
...
function cudnnConvolutionBackwardData(dx::CuArray{T,N}, w::CuArray{T,N}, dy::CuArray{T,N},
                                      cdims::DepthwiseConvDims; algo=0, workspace=CU_NULL,
...
function depthwiseconv!(y::CuArray{T}, x::CuArray{T}, w::CuArray{T}, cdims::DepthwiseConvDims;
...
function ∇depthwiseconv_filter!(dw::CuArray{T}, x::CuArray{T}, dy::CuArray{T},
                                cdims::DepthwiseConvDims; alpha=1, algo=0) where T<:CUDNNFloat
...
function ∇depthwiseconv_data!(dx::CuArray{T}, dy::CuArray{T}, w::CuArray{T},
                              cdims::DepthwiseConvDims; alpha=1, algo=0) where T<:CUDNNFloat
  workspace_size =
